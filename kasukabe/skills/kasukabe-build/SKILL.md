...
If the input file ends with .mp4/.mov/.avi/.mkv/.webm, spawn a subagent:

**Agent prompt**: Run video frame extraction:
```bash
...
Read the Architect skill template:
```
kasukabe/skills/architect/SKILL.md
```

Spawn an **Architect subagent** (model: see Model Configuration above) with this prompt:

> [Contents of architect/SKILL.md]
>
> **Workspace**: workspace/<SESSION_ID>
> **Origin**: x,y,z
> **Size**: WxHxL (0x0x0 = auto-detect)
> **Image files**: [list the frame files or input image path]
>
> Read each image file, analyze the structure, and write blueprint.json and architect_done.json.
...
Read `kasukabe/skills/planner/SKILL.md`.

If iteration > 1, also Read `workspace/<SESSION_ID>/diff_report.json` and extract `fix_commands`.

Spawn a **Planner subagent** (model: see config) with prompt:

> [Contents of planner/SKILL.md]
>
> **Workspace**: workspace/<SESSION_ID>
> **Origin**: x,y,z
> **Size**: WxHxL
...
Read `kasukabe/skills/builder/SKILL.md`.

Spawn a **Builder subagent** with prompt:

> [Contents of builder/SKILL.md]
>
> **Workspace**: workspace/<SESSION_ID>
> **Origin**: x,y,z
> **Size**: WxHxL
...
Read `kasukabe/skills/inspector/SKILL.md`.

Spawn an **Inspector subagent** (model: see config) with prompt:

> [Contents of inspector/SKILL.md]
>
> **Workspace**: workspace/<SESSION_ID>
> **Origin**: x,y,z
